...
[ ! -d out/target/product/pocket2plus/vendor/lib/npidevice ] && mkdir -p out/target/product/pocket2plus/vendor/lib/npidevice
[ ! -L out/target/product/pocket2plus/vendor/lib/npidevice/camera.ums312.so ] && ln -s /vendor/lib/hw/camera.ums312.so out/target/product/pocket2plus/vendor/lib/npidevice/camera.ums312.so
...
echo "" > out/target/product/pocket2plus/dtb.img
